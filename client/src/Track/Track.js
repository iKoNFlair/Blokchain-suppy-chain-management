    ...
    return (
      <Layout>
        <div className={styles["container-xl"]}>
          <article className={styles["col-4"]}>
            <h3>
              <b>
                <u>Medicine:</u>
              </b>
          ...
          <section className={styles["row"]}>
            <article className={styles["col-3"]}>
              <h4>
          ...
          <button
            ...
            className={`${styles["btn"]} ${styles["btn-outline-success"]} ${styles["btn-sm"]}`}
          >
            Track Another Item
          </button>
        </div>
  ...
  return (
    <Layout>
      ...
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>Track Medicine</h1>
        ...
        <h2 className={styles.trackMedicineTitle}>
          Enter Medicine ID to Track
        </h2>

        <form onSubmit={handlerSubmit} className={styles.trackMedicineForm}>
          <input
